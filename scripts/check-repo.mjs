...
function checkPolicy() {
  ...
  if (policy.productName !== "TurboWarp-Sesame")
    errors.push("Unexpected productName");
...
function checkPackageMetadata() {
  ...
  if (
    ...
    "git+https://github.com/kubohiroya/turbowarp-sesame.git"
  ) {
    errors.push(
  ...
  if (
    ...
    "https://github.com/kubohiroya/turbowarp-sesame/issues"
  ) {
    errors.push(
...
async function checkPackContents() {
  ...
  if (!files.has("dist/turbowarp-sesame.js")) {
